...
using InventoryControlAngularJS.Sessions;
using InventoryControlAngularJS.Web.Controllers.Results;
using InventoryControlAngularJS.Web.Models;
using InventoryControlAngularJS.Web.Models.Account;
...
{
    public class AccountController : InventoryControlAngularJSControllerBase
    {
